    ...
    public static String _list(int index, CALL f) {
        ...
        switch(f) {
            case START:
                ...
                s.append("Iterator _iter").append(index).append(" = attrs").append(index).append("['items'].iterator();");
                s.append("for (_").append(index).append("_i = 1; _iter").append(index).append(".hasNext(); _").append(index).append("_i++) {");
                s.append("def _item").append(index).append(" = _iter").append(index).append(".next();");
